...
function normaliseQuestions(raw:any, facts:any[]){
  ...
  while (out.length < 8) out.push({ id: "q"+(out.length+1), prompt: "", type: "short", answer: "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" } as any);
  return out;
}
function alignAdaptedToStandard(stdQs:any[], adpQs:any[]){
  ...
  return a.map((q:any,i:number)=>{
    ...
    return {
      ...
      answer: (q?.answer && String(q.answer).trim()) ? String(q.answer).trim() : (s?.answer || "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â"),
    };
  });
}
...
function fillTeacherKeyFromQuestions(teacher_key:any[], packs:any[], facts:any[]){
  ...
  for (const p of packs) {
    ...
    for (const q of qs) {
      ...
      teacher_key.push({ answer_id: id, answer: text || "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" });
      known.add(id);
    }
  }
  return teacher_key;
...
function extractPreteachFromText(text:string){
  ...
  const tokens = (lower.match(/[a-zÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â©ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â­ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â³ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚ÂºÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¼ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â±ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â§ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¦][a-zÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â©ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â­ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â³ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚ÂºÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¼ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â±ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â§ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¦'\-]{2,}/gi) || []).map(t => t.replace(/^'+|'+$/g,""));
  ...
  const clean = (w:string)=> (w||"").replace(/[^a-zÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â©ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â­ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â³ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚ÂºÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¼ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â±ÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â§ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÆ’Ã†\u2019Ãƒâ€šÃ‚Â¦'\-]/gi,"");
  ...
  return candidates.slice(0, 12).map(t => ({
    term: t,
    definition: "From the passage ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pre-teach meaning and one example sentence.",
    note: undefined
  }));
}
function buildTeacherNotes(
  ...
  if (ext.length < 2) {
    ext = [
      ...
      "Short writing: 90ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ120 words reusing 6+ target items (highlight them); swap and give one improvement each."
    ];
...
1ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ5: comprehension ("comp")
6: language ("synonym" or "antonym") ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â MCQ
7: language ("grammar") ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â MCQ
8: language ("collocation" or "reference") ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â MCQ
STANDARD RULES
- Use requested CEFR, text type/register, and OUTPUT language.
- Standard text must be close to WORD_TARGET.
ADAPTED RULES
- SAME CEFR and canonical facts; 75ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ85% of Standard length.
...
function userPrompt(params: TGenerateRequest, source: string, wordTarget: number) {
  ...
  const levelLines = [
    ...
    "- ESL targets (Q6ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œQ8): " + spec.esl_targets.join("; ")
  ];
  return [
...
export async function POST(request: NextRequest) {
  try {
    ...
    const teacher_key_common = [
      ...(facts || []).map((f:any, i:number)=>({ label: "F"+(i+1), text: asString(f.text).trim() || "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" })),
...
function normaliseQuestions2(raw:any, facts:any[]) {
  ...
  while (out.length<8) out.push({ id: "q"+(out.length+1), prompt: "", type: "short", answer_id: "F1", answer:"ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â", skill:"comp" });
  return out;
}
function alignAdaptedToStandard2(stdQs:any[], adpQs:any[]){
  return adpQs.map((q:any,i:number)=>{
    ...
    return {
      ...q,
      answer_id: q?.answer_id || s?.answer_id || "",
      answer: (typeof q?.answer==="string" && q.answer.trim()) ? q.answer.trim() : (s?.answer || "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â")
    };
  });
}
...
function sanitizeModelJson2(modelJson:any, parsed:TGenerateRequest, wordTarget:number){
  ...
  const teacher_key_common = [
    ...(facts||[]).map((f:any,i:number)=>({ label: "F"+(i+1), text: String(f?.text ?? "").trim() || "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" })),
